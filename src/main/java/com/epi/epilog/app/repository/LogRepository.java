...
public interface LogRepository extends JpaRepository<Log, Long> {
    ...
    List<Log> findAllByMemberAndStartAndEnd(@Param("member") Member member,
    ...
    @Query("select l from Log l " +
            "where l.member = :member and function('YEAR', l.date) = :year and function('MONTH', l.date) = :month ")
    List<Log> findAllByMonthAndMember(@Param("year") Integer year,
